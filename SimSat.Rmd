...
SAT <- function (Beta=0, rangeE = 1.5, rangeR = 2.5, psill = 0.05, Nsimulation =10, Nrow = 5, Ncol = 5, deterministic = "Xgradient"){
  ...
  names(output) <- c("Proportion", "p-values", "rangeE", "rangeR")
...
rangeEvec = c(0.001, 1, 2) ## Variogram ranges for E
rangeRvec = c(0.001, 1, 2) ## Variaogram ranges for R
...
for(i in 1:nrow(params)){
  ...
  print(c(paste("Result #",i),SAT(Beta=0, rangeE = 1, rangeR = params[i, 1], psill = params[i,2], Nsimulation =50, Nrow = 5, Ncol = 5, deterministic = "Xgradient")))
}
```
