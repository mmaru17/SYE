...
for(i in 1:nrow(params)){
  ...
  Result <-data.frame(SAT(Beta=0, rangeE = params[i, 1], rangeR = params[i, 2], psill = 0.7, Nsimulation =500, Nrow = 10, Ncol = 10, deterministic = "Random")) ## new dataframe for each function call. 
