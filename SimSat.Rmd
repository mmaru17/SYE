...
for(i in 1:nrow(params)){
  ...
  Result <-data.frame(SAT(Beta=0.3, rangeE = params[i, 1], rangeR = params[i, 2], psill = 0.3, Nsimulation =500, Nrow = 10, Ncol =10, deterministic = "XYgradient", Nsample = 50, SampleDesign = "Systematic")) ## new dataframe for each function call. 
